    ...
    deleSetcion:function($,content,index,arry){
        function find_head(strIndex,strIndex_1,str){
            ...
            if(str_1.indexOf(">") > -1){
                ...
                return find_head(strIndex_1,newIndex,str);
            }
        }
        function find_foot(strIndex,strIndex_2,str){
            ...
            if(str_1.indexOf("</") > -1){
                ...
                return find_foot(strIndex_2,newIndex,str);
            }
        }
        if(!index || index == ""){
            ...
            for(var i = 0; i < arry.length; i++){
                ...
                if(strIndex > -1){
                    ...
                    console.log("---------------str" + arry[i])
                    console.log("---------------strIndex_1" + strIndex_1)
                    var strIndex_2 = str.indexOf(">",strIndex);
                    strIndex_2 = find_foot(strIndex,strIndex_2,str);
                    console.log("---------------strIndex_2" + strIndex_1)
